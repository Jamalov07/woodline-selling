import { $Enums, SPStatusEnum } from '@prisma/client'
...
{
	@ApiPropertyOptional({ enum: SPStatusEnum, isArray: true })
	@IsOptional()
	@IsArray()
	@IsEnum(SPStatusEnum, { each: true })
	statuses?: $Enums.SPStatusEnum[]
