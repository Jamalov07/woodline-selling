...
export class UserFindOneDataDto extends PickType(UserRequiredDto, ['id', 'phone', 'fullname', 'createdAt', 'deletedAt']) implements UserFindOneData {}
...
export class UserFindManyResponseDto extends GlobalResponseDto implements UserFindManyResponse {
	...
	data: UserFindManyData | { data: UserFindOneData[] }
}
export class UserFindOneActionIdsDto {
	@ApiProperty({ type: String, isArray: true })
	actionIds?: string[]
}
export class UserFindOneResponseDto extends GlobalResponseDto implements UserFindOneResponse {
	@ApiProperty({ type: IntersectionType(UserFindOneDataDto, UserFindOneActionIdsDto) })
	data: UserFindOneData & { actionIds?: string[] }
}
