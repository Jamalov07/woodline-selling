...
export class FurnitureTypeFindOneRequestDto extends PickType(FurnitureTypeOptionalDto, ['name', 'id']) implements FurnitureTypeFindOneRequest {}
...
export class FurnitureTypeUpdateOneRequestDto extends PickType(FurnitureTypeOptionalDto, ['name']) implements FurnitureTypeUpdateOneRequest {}
