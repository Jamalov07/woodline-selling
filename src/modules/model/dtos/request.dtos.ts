...
export class ModelFindManyRequestDto
	extends IntersectionType(PaginationRequestDto, PickType(RequestOtherFieldsDto, ['ids', 'isDeleted']), PickType(ModelOptionalDto, ['name', 'furnitureTypeId', 'partnerId']))
...
export class ModelCreateOneRequestDto extends PickType(ModelRequiredDto, ['name', 'furnitureTypeId', 'partnerId']) implements ModelCreateOneRequest {}

export class ModelUpdateOneRequestDto extends PickType(ModelOptionalDto, ['name', 'deletedAt', 'furnitureTypeId', 'partnerId']) implements ModelUpdateOneRequest {}
